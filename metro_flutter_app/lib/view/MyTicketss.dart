...
class _myticketsState extends State<mytickets> {
    ...
    return Padding(
      ...
      child: Container(
          ...
          Padding(
            ...
            child:
            GridView.builder(itemCount: count, gridDelegate:
  ...
  Padding buildchoices(List<String> cat) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: kDefulpadding,vertical:45),
      child: SizedBox(
        height: 30,
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    width: 110,
                    decoration: BoxDecoration(
                      color: selectedindex== index ?  Color(0xffa80f14) : Colors.white ,
                    ...
                    child: Center(
                      child: Text(cat[index],style:TextStyle(
                        fontWeight: FontWeight.bold,
